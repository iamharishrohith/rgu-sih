...
export default function BulkWhatsAppSender({ teamRecords, onUpdateContact }) {
  ...
  const templates = {
    deadline: 'Hello {leader_name} (Team: {team_name}, ID: {temp_team_id}),\n\n🚨 URGENT: The SIH 2026 Candidate Registration Portal is REOPENED & LIVE.\n\nYour team is selected under [{tier_status}] for Problem Statement {ps_id}.\n\nPlease complete your mandatory 6-member roster and mentor details ASAP on the official portal:\nhttps://rgu-sih.vercel.app\n\n*NOTE FOR TEAMS WITH ISSUES / SHORTAGE OF MEMBERS:*\nIf facing any member shortage or registration issues, reply immediately:\n\nTeam Name: {team_name}\nPS ID: {ps_id}\nStatus of Team: {tier_status}\nIssue: \n\nRegards,\nSIH 2026 Coordination Desk\nRathinam Global University',
    shortlist_congrats: 'Congratulations {leader_name}!\n\nYour team {team_name} ({temp_team_id}) is selected for Smart India Hackathon 2026 for Problem Statement {ps_id}.\n\nThe candidate portal is now OPEN. Please complete your official 6-member roster and mentor verification ASAP:\nhttps://rgu-sih.vercel.app\n\n*NOTE FOR TEAMS WITH ISSUES / SHORTAGE OF MEMBERS:*\nPost your team details and issue:\n\nTeam Name: {team_name}\nPS ID: {ps_id}\nStatus of Team: {tier_status}\nIssue: \n\nRegards,\nRathinam Global University',
